			...
			title={
				<div className="flex flex-col gap-1.5">
					<div className="flex items-center gap-4">
						...
						<h1 className="text-4xl md:text-5xl font-black tracking-tight flex flex-col sm:flex-row sm:items-baseline sm:gap-2">
			...
			<div className="relative flex flex-col gap-8">
				...
				<Tabs value={activeTab} onValueChange={setActiveTab} className="w-full focus-visible:outline-none relative z-10">
					<motion.div variants={itemVariants}>
						<TabsList className="grid w-full grid-cols-2 md:grid-cols-4 h-auto p-1.5 bg-card/40 backdrop-blur-2xl border border-border/40 rounded-3xl shadow-2xl mb-8 relative z-20 overflow-hidden">
							<div className="absolute inset-0 bg-gradient-to-r from-primary/5 via-transparent to-primary/5 opacity-30" />
							<TabsTrigger value="chat" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:shadow-[0_0_20px_rgba(var(--primary),0.1)] rounded-2xl py-4 text-xs font-black tracking-[0.1em] uppercase flex gap-3 items-center transition-all duration-500 z-10"><Brain className="h-4 w-4" /> AI Interface</TabsTrigger>
							<TabsTrigger value="community" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:shadow-[0_0_20px_rgba(var(--primary),0.1)] rounded-2xl py-4 text-xs font-black tracking-[0.1em] uppercase flex gap-3 items-center transition-all duration-500 z-10"><GraduationCap className="h-4 w-4" /> Study Circles</TabsTrigger>
							<TabsTrigger value="library" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:shadow-[0_0_20px_rgba(var(--primary),0.1)] rounded-2xl py-4 text-xs font-black tracking-[0.1em] uppercase flex gap-3 items-center transition-all duration-500 z-10"><Sparkles className="h-4 w-4" /> Neuro Library</TabsTrigger>
							<TabsTrigger value="tools" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:shadow-[0_0_20px_rgba(var(--primary),0.1)] rounded-2xl py-4 text-xs font-black tracking-[0.1em] uppercase flex gap-3 items-center transition-all duration-500 z-10"><Wrench className="h-4 w-4" /> Logic Tools</TabsTrigger>
						</TabsList>
					</motion.div>

					<TabsContent value="chat" className="mt-0 focus-visible:outline-none flex justify-center">
						<motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4 }} className="w-full max-w-5xl h-[600px] relative group">
					...
					<TabsContent value="community" className="mt-0 focus-visible:outline-none">
						<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="bg-card/30 backdrop-blur-3xl border border-border/40 rounded-[2rem] p-6 shadow-2xl min-h-[600px] ring-1 ring-white/5 relative overflow-hidden">
					...
					<TabsContent value="tools" className="mt-0 focus-visible:outline-none">
						<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="bg-card/30 backdrop-blur-3xl border border-border/40 rounded-[2rem] p-8 shadow-2xl min-h-[600px] flex flex-col ring-1 ring-white/5">
							<Tabs value={activeToolTab} onValueChange={setActiveToolTab} className="flex-1 flex flex-col h-full">
								<TabsList className="grid grid-cols-3 md:grid-cols-6 gap-3 bg-muted/20 p-1.5 h-auto mb-8 rounded-2xl border border-border/20 backdrop-blur-md">
									<TabsTrigger value="notes" className="text-[10px] font-black uppercase tracking-[0.15em] py-4 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border border-transparent data-[state=active]:border-primary/20 rounded-xl shadow-xl transition-all duration-300">Notes</TabsTrigger>
									<TabsTrigger value="plan" className="text-[10px] font-black uppercase tracking-[0.15em] py-4 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border border-transparent data-[state=active]:border-primary/20 rounded-xl shadow-xl transition-all duration-300">Plan</TabsTrigger>
									<TabsTrigger value="quiz" className="text-[10px] font-black uppercase tracking-[0.15em] py-4 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border border-transparent data-[state=active]:border-primary/20 rounded-xl shadow-xl transition-all duration-300">Quiz</TabsTrigger>
									<TabsTrigger value="timer" className="text-[10px] font-black uppercase tracking-[0.15em] py-4 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border border-transparent data-[state=active]:border-primary/20 rounded-xl shadow-xl transition-all duration-300">Focus</TabsTrigger>
									<TabsTrigger value="gpa" className="text-[10px] font-black uppercase tracking-[0.15em] py-4 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border border-transparent data-[state=active]:border-primary/20 rounded-xl shadow-xl transition-all duration-300">GPA</TabsTrigger>
									<TabsTrigger value="flashcards" className="text-[10px] font-black uppercase tracking-[0.15em] py-4 data-[state=active]:bg-primary/20 data-[state=active]:text-primary border border-transparent data-[state=active]:border-primary/20 rounded-xl shadow-xl transition-all duration-300">Cards</TabsTrigger>
								</TabsList>
